import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, a as validate_slots, L as createEventDispatcher, e as element, b as space, t as text, c as claim_element, f as children, g as detach_dev, h as claim_space, j as claim_text, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, U as set_input_value, o as listen_dev, V as prevent_default, W as prop_dev, q as noop, K as run_all, Y as assign, u as stores$1, w as validate_store, x as component_subscribe, T as goto, E as create_component, P as query_selector_all, F as claim_component, G as mount_component, Z as get_spread_update, _ as get_spread_object, B as transition_in, z as transition_out, H as destroy_component, X as set_store_value } from './client.94090096.js';
import { L as ListErrors } from './ListErrors.e42d8991.js';
import { p as post } from './utils.e9b5673a.js';

/* src\routes\_SettingsForm.svelte generated by Svelte v3.36.0 */
const file = "src\\routes\\_SettingsForm.svelte";
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*inProgress*/ 32) {
				prop_dev(button, "disabled", /*inProgress*/ ctx[5]);
			}
		},
		i: noop,
		o: noop,
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SettingsForm> was created with unknown prop '${key}'`);
	});
...
class SettingsForm extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*inProgress*/ ctx[5] === undefined && !("inProgress" in props)) {
		...
		if (/*bio*/ ctx[2] === undefined && !("bio" in props)) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			const head_nodes = query_selector_all("[data-svelte=\"svelte-tgkgny\"]", document.head);
		...
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(div2, "click", /*logout*/ ctx[4], false, false, false);
				mounted = true;
			}
		},
		p: function update(ctx, [dirty]) {
